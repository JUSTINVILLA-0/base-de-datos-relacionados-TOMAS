                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/justin01.php">pagina 1</a><br>
                            <a class="dropdown-item" href="/vac/justin02.php">pagina 2</a><br>
                            <a class="dropdown-item" href="/vac/justin03.php">pagina 3</a><br>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/justin04.php">pagina 4</a><br>
                            <a class="dropdown-item" href="/vac/justin05.php">pagina 5</a><br>
                            <a class="dropdown-item" href="/vac/justin06.php">pagina 6</a><br>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="/vac/justin07.html">Pokedex</a><br>
                            <a class="dropdown-item" href="/vac/justin08.html">Peliculas API</a><br>
                            <a class="dropdown-item" href="/vac/justin09.html">Dragon Ball API</a><br>
                            <a class="dropdown-item" href="/vac/justin10.html">Harry Potter & Rick and Morty API</a><br>
                        </div>
                    </li>
